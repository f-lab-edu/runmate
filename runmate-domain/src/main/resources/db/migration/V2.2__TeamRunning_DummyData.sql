...
insert into team_member(id, crew_user_id, team_id, individual_distance, individual_running_seconds)
values (1, 3, 1, 0, 0);
...
update team_member set team_member_status = 'ACCEPTED' where id = 1;
